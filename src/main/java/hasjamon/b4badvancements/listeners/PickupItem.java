...
public class PickupItem implements Listener {
    ...
    public static final List<String> mobHeads = Arrays.asList(
            ...
            "Salmon", "Fox", "Snow Fox", "Red Mooshroom", "Brown Mooshroom", "Zombie Fletcher", "Zombie Butcher",
            "Zombie Cartographer", "Zombie Cleric", "Zombie Farmer", "Zombie Fisherman", "Zombie Armorer",
